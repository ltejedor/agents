    ...
    return {
        ...
        resolveId: {
            ...
            handler(sourceId, importer, options) {
                // Only handle .tsx files that are in the resources directory
                if (!sourceId.endsWith(".tsx") || !sourceId.includes("/resources/")) return;
...
export default defineConfig({
    ...
    plugins: [react(), tiledPlugin()], // hint vite that tiled tilesets should be treated as external
